<head>
    ...
    <link href="{{asset('frontendAsset')}}/assets/css2-9?family=Jost:wght@200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">

    <!-- Google Monsterrat Font -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
    <link href="{{asset('frontendAsset')}}/assets/css2-10?family=Montserrat:wght@800&display=swap" rel="stylesheet">

    <!-- Google Leckerli Font -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
    <link href="{{asset('frontendAsset')}}/assets/css2-11?family=Leckerli+One&display=swap" rel="stylesheet">
